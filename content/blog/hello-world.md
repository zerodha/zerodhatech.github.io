...
- Be extremely particular about quality and consistency. That extra 50 KB of Javascript, or that 100 KB PNG on a web app, or that sudden 10ms spike in mean latency, is not acceptable. No matter how negligible the cost may be, it is a matter of principle of good engineering. It is okay to pause for a bit to do things the better way.
...
- Trust developers and tolerate (even terrible) mistakes. The key is in learning by trial and error and not repeating the same mistakes. Not everyone is a *10x hotshot ninja*, and that is okay. Everybody has their own critical role to play. Be patient and let talent grow. If someone fails to respect this and keeps repeating the same mistakes, they probably won't cut it. Fortunately, we have had very few instances of this.
